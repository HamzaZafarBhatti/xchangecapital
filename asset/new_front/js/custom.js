...
function changeImage(themeMode = "light") {
    ...
    if (icon) {
        if (themeMode === "dark") {
            icon.src = "asset/new_front/images/icon/sun.svg";
            ...
            icon.src = "asset/new_front/images/icon/moon.svg";
            var images = document.querySelectorAll("img.dark");
...
function toggleAllIconsDirection() {
    ...
    icons.forEach((icon) => {
        if (
            icon.classList.contains("fa-arrow-right") ||
            ...
            icon.classList.contains("fa-arrow-left") ||
            icon.classList.contains("fa-angle-left")
        ) {
