...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('user.update_bank_details', $user_bank->id) }}" method="post">
                @csrf
                @method('patch')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="bank_id" id="bank_id"
                                ...
                                @foreach ($banks as $bank)
                                    <option value="{{ $bank->id }}" @if($bank->id == $user_bank->bank_id) selected @endif>{{ $bank->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="account_type" id="account_type"
                                ...
                                <option value="saving" @if('saving' == $user_bank->account_type) selected @endif>Saving</option>
                                <option value="current" @if('current' == $user_bank->account_type) selected @endif>Current</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @if ($errors->get('account_name')) is-invalid @endif"
                                id="account_name" name="account_name" value="{{ $user_bank->account_name }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @if ($errors->get('account_number')) is-invalid @endif"
                                id="account_number" name="account_number" value="{{ $user_bank->account_number }}">
