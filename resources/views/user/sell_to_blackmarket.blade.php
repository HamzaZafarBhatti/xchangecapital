                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="text-center">
                            <br><h4 class="deadline-heading">Remaining Time For Trade To Complete</h4>
                    ...
                    <a href="https://arbyvest.com/app/sell_to_blackmarket" class="btn btn-primary w-100"
                                            type="button">
                            ...
                            @foreach ($logs as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->status)
                                            <span class="badge bg-success">
                                                Completed<img src="https://arbyvest.com/asset/front/img/uploads/check0marke3-removebg-preview.png" width="21" height="21" />
                                            </span>
                                        @else
                                            <span class="badge bg-warning">
                                                Pending<img src="https://arbyvest.com/asset/user/images/Cube-0.5s-187px.gif" width="24" height="24" />
                                            </span>
                                        @endif
                                    </td>
                                </tr>
